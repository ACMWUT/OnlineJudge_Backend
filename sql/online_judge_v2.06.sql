...
(00000092, 'fa fa-align-justify', '上传XML题目', 'src/page/problem/addxml.html', '_self', 1, 00000054),
(00000093, 'fa fa-cog', 'OJ全局配置管理', '', '_self', 1, 00000046),
(00000094, 'fa fa-cog', '配置列表', 'src/page/globalconfig/index.html', '_self', 1, 00000093),
(00000095, 'fa fa-align-justify', 'getAllConfig', '', '_self', 2, 00000093),
(00000096, 'fa fa-align-justify', 'editConfig', '', '_self', 2, 00000093);
...
INSERT INTO `global_config` (`id`, `name`, `status`) VALUES
(1, '注册权限', 0),
(2, '信息修改权限', 1);
...
CREATE TABLE `reply` (
  ...
  `identity` int(11) NOT NULL DEFAULT 0 COMMENT '0--非管理员  1--管理员 留言'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `auth`
  MODIFY `aid` int(8) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT COMMENT '编号', AUTO_INCREMENT=97;
...
--
-- 使用表AUTO_INCREMENT `global_config`
--
ALTER TABLE `global_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'config id', AUTO_INCREMENT=3;
...
--
ALTER TABLE `contest_problem`
  ADD CONSTRAINT `contest_problem_ibfk_1` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`contest_id`);
